...
import unicauca.edu.co.ms_gestion_maticula.app.domain.request.CursoMatriculaRequest;
...
import unicauca.edu.co.ms_gestion_maticula.app.ports.In.MatriculaService;
import unicauca.edu.co.ms_gestion_maticula.app.ports.out.CursoRepository;
import unicauca.edu.co.ms_gestion_maticula.app.ports.out.MatriculaRepository;
...
public class MatriculaServiceImpl implements MatriculaService {
    ...
    public List<Asignatura> obtenerAsignaturasDisponiblesporEstudiante(Long estudianteId) {
        ...
        List<Asignatura> todasLasAsignaturas = cursoRepository.findAsignaturasByStatus(true);
